   ...
   public partial class Home : ContentPage
    {
        ...
        {
            var answer = await DisplayAlert("Confirmation", "Confirm Delete Post", "Yes", "No");
            if (answer == true)
            {
                item.Done = true;
                await manager.DeleteTodoItem(item);
                todoList.ItemsSource = await manager.GetTodoItemsAsync();
            }
        }
        ...
        public async void OnAdd(object sender, EventArgs e)
        {
            ...
            var todo = new TodoItem { Name = newItemName.Text, Place = local.Text, Over = now, Start = now };
            //await AddItem(todo);
        ...
        public void OnComplete(object sender, EventArgs e)
        {
            ...
            backBtn.Clicked += (sender3, e3) => Navigation.PushAsync(new TabbedPage1());
        ...
        public async void Analytics_Clicked(object sender, EventArgs e)
        {
